...
import image2 from "../images/about-1.jpg"
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-5">
                <img className="img-fluid rounded mb-5 mb-lg-0" src={image2}alt="" />
              </div>
              <div className="col-lg-7">
                <p className="section-title pr-5" >
                  <span className="pr-2"style={{textAlign:'left'}}>Learn About Us</span>
                </p>
                <h1 className="mb-4"style={{textAlign:'left'}}>Best School For Your Kids</h1>
                ...
                <div className="row pt-2 pb-4">
                  ...
                  <div className="col-6 col-md-8" style={{textAlign:'left'}}>
