          ...
          <div className="row pt-5">
            <div className="col-lg-8">
              ...
              <div className="mb-5">
                ...
                <img className="img-fluid rounded w-50 float-left mr-4 mb-3" src={blog1} alt="Image" />
                <p style={{textAlign:"left"}}>
                ...
                <img className="img-fluid rounded w-50 float-right ml-4 mb-3" src={blog2} alt="Image" />
                <p style={{textAlign:"left"}}>
                  Diam dolor est labore duo invidunt ipsum clita et, sed et lorem
                  voluptua tempor invidunt at est sanctus sanctus. Clita dolores sit
                  kasd diam takimata justo diam lorem sed. Magna amet sed rebum eos.
              ...
              <div className="mb-5 mx-n3">
                ...
                <div className="owl-carousel post-carousel position-relative">
                  <div className="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                    <img className="img-fluid" src={post1} style={{width: '80px', height: '80px'}} />
                    <div className="pl-3">
                  ...
                  <div className="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                    <img className="img-fluid" src={post2} style={{width: '80px', height: '80px'}} />
                    <div className="pl-3">
                      <h5 className>Diam amet eos at no eos</h5>
                      <div className="d-flex">
                        <small className="mr-3"><i className="fa fa-user text-primary" /> Admin</small>
                  ...
                  <div className="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                    <img className="img-fluid" src={post3} style={{width: '80px', height: '80px'}} />
                    <div className="pl-3">
                      <h5 className>Diam amet eos at no eos</h5>
                      <div className="d-flex">
                        <small className="mr-3"><i className="fa fa-user text-primary" /> Admin</small>
              ...
              <div className="mb-5">
                ...
                <div className="media mb-4">
                  <img src={user} alt="Image" className="img-fluid rounded-circle mr-3 mt-1" style={{width: '45px'}} />
            ...
            <div className="col-lg-4 mt-5 mt-lg-0">
              ...
              <div style={{textAlign:"left"}}>
                <h2 className="mb-4" style={{textAlign:"center"}}>Plain Text</h2>
