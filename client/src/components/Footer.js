...
export const Footer = () => {
  return (
     <div className="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5" style={{backgroundColor:'#0C4A5A'}}>
          <div className="row pt-5">
            ...
            <div className="col-lg-3 col-md-6 mb-5">
              <h3 className="text-primary mb-4" style={{textAlign:left}}>Get In Touch</h3>
              <div className="d-flex">
                <h4 className="fa fa-map-marker-alt text-primary" />
                <div className="pl-3">
                  <h5 className="text-white" style={{textAlign:left}}>Address</h5>
              ...
              <div className="d-flex">
                ...
                <div className="pl-3">
                  <h5 className="text-white" style={{textAlign:left}}>Email</h5>
              ...
              <div className="d-flex">
                ...
                <div className="pl-3">
                  <h5 className="text-white" style={{textAlign:left}}>Phone</h5>
                  <p>+012 345 67890</p>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 mb-5">
              <h3 className="text-primary mb-4" style={{textAlign:left}}>Quick Links</h3>
              <div className="d-flex flex-column justify-content-start" style={{textAlign:left}}>
